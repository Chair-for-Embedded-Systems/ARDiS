...
def plot_normalized_efficiency_vs_time_with_rounded_subplots(applications, results, output_dir):
    ...
    for app_idx, app_name in enumerate(applications):
        ...
        #ax.set_xlabel('Normalized Execution Time', fontweight='bold')
        #ax.set_ylabel('Normalized Energy Efficiency', fontweight='bold')
    ...
    plt.savefig(os.path.join(output_dir, "motivational_example_subplots.pdf"), dpi=300, format='pdf')
    plt.close()
...
def main():
    ...
    plot_normalized_efficiency_vs_time_with_rounded_subplots(applications, results, output_dir)
